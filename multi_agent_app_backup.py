...
# Add these two functions to your multi_agent_app.py
# Replace your existing @app.get("/") function with these two

@app.get("/", response_class=HTMLResponse)
async def home():
    """Public landing page with demo request form"""
    html_content = """
    <!DOCTYPE html>
    <html lang="en">
    <head>
        ...
        <title>Stuttgart Building Regulations AI - Request Demo</title>
        <style>
    ...
    <body>
        <div class="container">
            <div class="header">
                ...
                <p>Multi-Agent System for German Building Code Analysis</p>
            </div>

            <div class="badge-container">
                <span class="badge">5 Specialized Agents</span>
                <span class="badge">8,826+ Documents</span>
                <span class="badge">Production Ready</span>
                <span class="badge">6-8 Min Analysis</span>
            </div>

            <div class="features">
                <h2>What This System Does</h2>
                <ul>
                    <li>Analyzes German building regulations across federal, state, and local levels</li>
                    <li>Processes complex queries using 5 specialized AI agents working in coordination</li>
                    <li>Generates professional consultation reports with precise legal citations</li>
                    <li>Covers BauGB, LBO Baden-Württemberg, and Stuttgart municipal codes</li>
                    <li>Provides technical standards analysis (DIN, fire safety, energy efficiency)</li>
                    <li>Delivers compliance roadmaps with cost-benefit analysis</li>
                </ul>
            </div>

            <div class="demo-section">
                <h2>Request Demo Access</h2>
                <p style="margin-bottom: 10px;">This system is currently in validation phase with architecture professionals.</p>
                <p style="margin-bottom: 20px; font-size: 14px; opacity: 0.9;">To run actual queries and see the full multi-agent system in action, please request access.</p>
                
                <a href="https://docs.google.com/forms/d/e/1FAIpQLSfGaD3kMJvQq3Mn0wmzxIY3TRo5Ni2fMAUVtGfriRawBpD5Hg/viewform?usp=header" target="_blank" class="demo-button">
                    Request Demo Access
                </a>
                
                <p style="margin-top: 20px; font-size: 14px;">You'll receive access credentials within 24 hours</p>
            </div>

            <div class="contact">
                <p style="margin-bottom: 10px;"><strong>Technical Documentation:</strong> <a href="https://github.com/meet-rehman/stuttgart-building-regulations-ai" target="_blank">View on GitHub</a></p>
                <p><strong>Direct Contact:</strong> <a href="mailto:meet.archrehman@gmail.com">meet.archrehman@gmail.com</a></p>
            </div>
        </div>
    </body>
    </html>
...
@app.get("/demo-full", response_class=HTMLResponse)
async def demo_full():
    """Full working interface for scheduled demos - share this URL only during meetings"""
    html_content = """
    <!DOCTYPE html>
    <html lang="en">
    <head>
            ...
            document.getElementById('analysisForm').addEventListener('submit', async function(e) {
                ...
                resultsContent.innerHTML = `
                    <div class="loading">
                        ...
                        <p><small>This may take 6-8 minutes as our agents collaborate</small></p>
                    </div>
                `;
